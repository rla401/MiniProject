		...
		<div class="col-sm-6">
			<div class="card shadow">
				...
				<form:form action="${root }user/join_pro" method='post' modelAttribute="joinUserBean">
						<form:hidden path="userIdExist"></form:hidden>
						<div class="form-group">
							<form:label path="user_name">이름</form:label>
							<form:input path="user_name" class="form-control"></form:input>
							<form:errors path="user_name" style="color:red"></form:errors>
						</div>
						<div class="form-group">
							<form:label path="user_id">아이디</form:label>
							<div class="input-group">
								<form:input path="user_id" class='form-control' onkeypress="resetUserIdExist"></form:input>
						...
						<div class="form-group">
							...
							<form:password path="user_pw2" class='form-control'></form:password>
