			...
			<div class="card shadow">
				<div class="card-body">
					<form:form action='${root }board/modify_pro' method='post' modelAttribute="modifyContentBean" enctype="multipart/form-data">
						<form:hidden path="content_idx"></form:hidden>
						<form:hidden path="content_board_idx"></form:hidden>
						<input type='hidden' name='page' value='${page }' />
						<div class="form-group">
							<form:label path="content_writer_name">작성자</form:label>
							<form:input path="content_writer_name" class="form-control" readonly="true"></form:input>
						</div>
						<div class="form-group">
							<form:label path="content_date">작성날짜</form:label>
							<form:input path="content_date" class="form-control" readonly="true"></form:input>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<form:label path="content_text">제목</form:label>
						...
						<div class="form-group">
							...
							<form:hidden path="content_file"></form:hidden>
							</c:if>
							<form:input path="upload_file" type='file' class="form-control" accept="image/*"></form:input>				
						</div>
						<div class="form-group">
