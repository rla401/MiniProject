				...
				<div class="card shadow">
					<div class="card-body">
						...
						<c:if test="${readContentBean.content_file != null }">
							...
							<c:import url="/WEB-INF/views/reply/reply_form.jsp"/>
							<%-- <form:form action='${root }board/reply_pro' method='post' modelAttribute="replyContentBean">
							<div class="form-group">
								<form:label path="reply_text">Comment</form:label>
								<form:label path="reply_text">Comment</form:label>
								<form:textarea path="reply_text" id="reply_text" name="reply_text" class="form-control" rows="5" style="resize:none"></form:textarea>
							</div>
							</form:form> --%>
						</c:if>
						<div class="form-group">
